...
struct xfm10213_info {
	...
	proc_dir_entry * xfm10213_proc_entry;
};


unsigned char * xfm10213_read_byte(struct i2c_client *client, unsigned char sub_addr, unsigned char data);
int xfm10213_send_byte(struct i2c_client *client, unsigned char sub_addr, unsigned char data);
xfm10213_work_mode xfm10213_get_current_work_mode(struct xfm10213_info);
int xfm10213_set_to_mode(struct xfm10213_info * info, xfm10213_info mode);
int xfm10213_create_proc_file(struct xfm10213_info * info);
int xfm10213_remove_proc_file(struct xfm10213_info * info);
