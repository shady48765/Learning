...
/** -------------- function macro switch start-------------------*/
//#ifndef CONFIG_GTP_ESD_PROTECT
//    #define     CONFIG_GTP_ESD_PROTECT                1
//#endif

#ifndef TPD_RESET_ISSUE_WORKAROUND
    #define TPD_RESET_ISSUE_WORKAROUND                  1
#endif

#ifndef TPD_HAVE_CALIBRATION
    #define TPD_HAVE_CALIBRATION                        1
#endif

#ifndef TPD_NO_GPIO
    #define TPD_NO_GPIO                                 1
#endif

//send touch panel chip configurate data macro
#ifndef CONFIG_GTP_DRIVER_SEND_CFG
    #define CONFIG_GTP_DRIVER_SEND_CFG                  1
#endif

#ifndef CONFIG_GTP_CREATE_WR_NODE
...
//#ifndef CONFIG_GTP_HOTKNOT
//    #define CONFIG_GTP_HOTKNOT                        1
//#endif

//#ifndef CONFIG_GTP_SUPPORT_I2C_DMA
//    #define CONFIG_GTP_SUPPORT_I2C_DMA                1
//#endif
...
//    #define UPDATE_FUNCTIONS                          1
//#endif

#ifndef ELINK_TP_SUUPORT
    #define ELINK_TP_SUUPORT                          1
#endif
...
// for debug start 
#define CONFIG_GTP_DEBUG_ON                         1
#define CONFIG_GTP_DEBUG_FUNC_ON                    1
#define CONFIG_GTP_DEBUG_ARRAY_ON                   1
...
extern s32 gt9xx_init_panel(struct i2c_client *client);
extern void gt9xx_reset_guitar(struct i2c_client *client, s32 ms);
extern void gt9xx_int_sync(s32 ms);
extern u8 gt9xx_init_update_proc(struct i2c_client *client);
extern u8 gt9xx_init_fw_proc(struct i2c_client *client);
extern s32 gt9xx_i2c_read(struct i2c_client *client, u8 *buf, s32 len);
extern s32 gt9xx_i2c_write(struct i2c_client *client, u8 *buf, s32 len);
...
extern s32 gt9xx_i2c_read_dbl_check(struct i2c_client *client, u16 addr, u8 *rxbuf, int len);
extern void gt9xx_gpio_output(int gpio_type, int level);
extern void gt9xx_gpio_input(int gpio_type);
extern void gt9xx_irq_enable(void);
extern void gt9xx_irq_disable(void);
...
extern struct tpd_device *tpd_dev;
