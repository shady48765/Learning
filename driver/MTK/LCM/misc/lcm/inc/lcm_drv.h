...
#include <mach/elink_include/items.h>

#ifndef ARY_SIZE
#define ARY_SIZE(x) (sizeof((x)) / sizeof((x[0])))
#endif

extern void elink_lcm_dvdd(int value);
extern void elink_lcm_avdd(int value);
extern void elink_lcm_ext_power(int value);
extern void elink_lcm_reset(int value);
extern void elink_lcm_standby(int value);
extern void elink_lcm_edp_power(int value);
extern void elink_lcm_edp_standby(int value);
/* --------------------------------------------------------------------------- */
